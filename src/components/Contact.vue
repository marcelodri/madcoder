<template>
    <div id="contact" class="section bg-color-2">
        <div class="container">
            <div class="row">
                <div class="col-12 col-xl-6">
                    <h2 class="text-5 tx-color-1 fw-bold" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-offset="0">{{ $t('contact_title') }}</h2>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="subtitle">
